...
class BisectingKMeansModel private[clustering](
  ...
  def toAdjacencyList: Array[(Int, Int, Double)] = this.root.toAdjacencyList
  ...
  def toJavaAdjacencyList: java.util.ArrayList[java.util.ArrayList[java.lang.Double]] = {
    ...
    this.root.toAdjacencyList.foreach { x =>
  ...
  def toLinkageMatrix: Array[(Int, Int, Double, Int)] = this.root.toLinkageMatrix

  /** Since Java doesn't support tuple, we must support the data structure for java and py4j. */
  def toJavaLinkageMatrix: java.util.ArrayList[java.util.ArrayList[java.lang.Double]] = {
    val javaList = new java.util.ArrayList[java.util.ArrayList[java.lang.Double]]()
    this.root.toLinkageMatrix.foreach { x =>
...
object BisectingKMeansModel extends Loader[BisectingKMeansModel] {
  ...
  override def load(sc: SparkContext, path: String): BisectingKMeansModel = {
    ...
    inputrdd.aggregate(("", 0))((acc, value) => (acc._1 + value, acc._2 + 1),(acc1, acc2) => (acc1._1 + acc2._1, acc1._2 + acc2._2))
