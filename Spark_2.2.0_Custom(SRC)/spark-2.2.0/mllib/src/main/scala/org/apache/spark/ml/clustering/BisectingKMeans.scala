...
class BisectingKMeansModel private[ml] (
  ...
  def toJavaLinkageMatrix: java.util.ArrayList[java.util.ArrayList[java.lang.Double]]=parentModel.toJavaLinkageMatrix

  def toAdjacencyList: Array[(Int, Int, Double)]=parentModel.toAdjacencyList

  def toJavaAdjacencyList: java.util.ArrayList[java.util.ArrayList[java.lang.Double]] =parentModel.toJavaAdjacencyList
